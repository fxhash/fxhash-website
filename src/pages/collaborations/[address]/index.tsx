...
const CollaborationIndex: NextPage<Props> = ({
  collaboration,
}) => {
  return (
    <>
      <Head>
        ...
        <meta key="description" name="description" content="A page to consult and manage the state of a collaboration contract."/>
      </Head>
