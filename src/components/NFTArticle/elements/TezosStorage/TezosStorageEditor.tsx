...
export interface TezosStorageProps
  extends PropsWithChildren<ITezosStoragePointer> {
  element: any
}
const TezosStorageEditor = forwardRef<HTMLDivElement, TezosStorageProps>(
  (
    { contract, path, storage_type, data_spec, value_path, element, children },
    ref
  ) => {
    ...
    return (
      <div ref={ref}>
        <div contentEditable={false}>
          {empty ? (
            ...
            >
              ...
              <span>Insert fxhash content</span>
            </button>
          ) : (
            <TezosStorageDisplay
              contract={contract}
        ...
        {showModal && (
          <BlockParamsModal onClose={() => setShowModal(false)}>
