  ...
  return (
    <div className={cs(style.root)}>
      <h1 className={cs(style.presentation_text)}>
        fxhash is an open platform to{" "}
        <span className={cs(Colors.primary)}>create</span> and{" "}
        <span className={cs(Colors.secondary)}>collect</span> generative NFTs on
          ...
          <Link href="/doc/collect/guide">
            <a className={cs(style.guide)}>
              ...
              <div className={cs(style.guide_details)}>
                ...
                <span>
                  Learn about the core principles behind fxhash, and how to use
                  the platform as an educated collector
                </span>
              </div>
            </a>
          </Link>
          <Link href="/doc/artist/guide-publish-generative-token">
            <a className={cs(style.guide)}>
              ...
              <div className={cs(style.guide_details)}>
                ...
                <span>
                  An in-depth guide to cover what you need to know as an artist
                  to publish your work on the platform
                </span>
              </div>
            </a>
          </Link>
