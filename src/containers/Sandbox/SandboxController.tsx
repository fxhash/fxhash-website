...
import { ArtworkIframeRef, SandboxPreview } from "../../components/Artwork/SandboxPreview"
...
export const SandboxController: FunctionComponent<Props> = ({
  ...
  const [readyState, setReadyState] = useState<SandboxReadyState>(SandboxReadyState.NONE)

  // the SandboxModule is derived from the mode
  const sandboxModule = useMemo<SandboxModule>(() => SandboxModuleFactory(mode), [mode])
