...
module.exports = withBundleAnalyzer({
  ...
  redirects() {
    return [
      ...
      { source: "/u/:name/activity", destination: "/u/:name", permanent: true },
      { source: "/pkh/:name/activity", destination: "/pkh/:name", permanent: true },
      { source: "/u/:name/dashboard", destination: "/u/:name", permanent: true },
      { source: "/pkh/:name/dashboard", destination: "/pkh/:name", permanent: true },
